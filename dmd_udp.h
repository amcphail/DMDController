...
#define IMAGE_TYPE_BINARY  1  // was 1
...
int char_to_int32(char const*);
unsigned int char_to_uint32(char const*);

short int char_to_int16(char const*);
unsigned short int char_to_uint16(char const*);

/*-----------------------------------------------------------------------------------------------*/

void int16_to_char(short int,char*);
void uint16_to_char(unsigned short int,char*);

void int32_to_char(int,char*);
void uint32_to_char(unsigned int,char*);

void int64_to_char(long int,char*);
void uint64_to_char(unsigned long int,char*);
...
class UDPPayload
{
 public:
  ...
  virtual void toBytes(QByteArray&);
...
class UnsignedInt : public Payload
{
 public:

  UnsignedInt(QByteArray);
  UnsignedInt(unsigned int li) { unsigned_int = li; }
  UnsignedInt(const UnsignedInt&);
  ~UnsignedInt() {}

  int size() { return 4; }
  UnsignedInt* clone() { return new UnsignedInt(unsigned_int); }
...
class UnsignedLongInt : public Payload
{
 public:
  ...
  UnsignedLongInt(QByteArray);
  UnsignedLongInt(unsigned long int li) { unsigned_long_int = li; }
...
class Ack : public UnsignedShortInt
{
 ...
 Ack(QByteArray buf) : UnsignedShortInt(buf) {}
...
class InumSize : public UnsignedShortInt
{
 public:
  ...
  InumSize(QByteArray buf) : UnsignedShortInt(buf) {}
...
class ImageType : public UnsignedShortInt
{
 public:
  ...
  ImageType(QByteArray buf) : UnsignedShortInt(buf) {}
...
class ImageData : public Payload
{
 public:
  ...
  ImageData(const int,QByteArray);
...
class EnableFCM : public Char
{
 public:
  ...
  EnableFCM(QByteArray buf) : Char(buf) {}
...
class InternalImage : public Char
{
 public:
  ...
  InternalImage(QByteArray buf) : Char(buf) {}
...
class AutoloadInternalImage : public Payload
{
 public:
  ...
  AutoloadInternalImage(QByteArray);
...
class TriggerCount : public UnsignedShortInt
{
 ...
 TriggerCount(QByteArray buf) : UnsignedShortInt(buf) {}
...
class LightPulseDuration : public UnsignedShortInt
{
 ...
 LightPulseDuration(QByteArray buf) : UnsignedShortInt(buf) {}
...
class TrigDelay : public UnsignedShortInt
{
 ...
 TrigDelay(QByteArray buf) : UnsignedShortInt(buf) {}
...
class TrigDivide : public UnsignedShortInt
{
 ...
 TrigDivide(QByteArray buf) : UnsignedShortInt(buf) {}
...
class ActiveSequence : public Char
{
 public:
  ...
  ActiveSequence(QByteArray buf) : Char(buf) {}
...
class AutostartSequencer : public Char
{
 public:
  ...
  AutostartSequencer(QByteArray buf) : Char(buf) {}
...
class DmdMirrorShake : public Char
{
 public:
  ...
  DmdMirrorShake(QByteArray buf) : Char(buf) {}
...
class IllumLed : public Char
{
 public:
  ...
  IllumLed(QByteArray buf) : Char(buf) {}
...
class ErrorStatus : public UnsignedInt
{
 public:
  
 ErrorStatus(QByteArray buf) : UnsignedInt(buf) {}
  ErrorStatus(unsigned long int li) : UnsignedInt(li) {}
 ErrorStatus(const ErrorStatus& ack) : UnsignedInt(ack) {}
  ~ErrorStatus() {}
  
  inline unsigned int getErrorStatus() { return unsigned_int; }
...
namespace UDP_Helper
{
  ...
  UDPPayload* ReplySequencerState(QByteArray);
  
  UDPPayload* RequestSeqFileErrorLog();
  UDPPayload* ReplySeqFileErrorLog(QByteArray);

  UDPPayload* SetSoftwareSync(bool);
  UDPPayload* RequestSoftwareSync();
  UDPPayload* ReplySoftwareSync(QByteArray);

  UDPPayload* RequestTriggerCount();
  UDPPayload* ReplyTriggerCount(QByteArray);
  ...
  UDPPayload* ReplyNetworkSettings(QByteArray);
  ...
  UDPPayload* ReplyFwVersion(QByteArray);
  
  UDPPayload* RequestDmdInfo();
  UDPPayload* ReplyDmdInfo(QByteArray);
  
  UDPPayload* RequestErrorStatus();
  UDPPayload* ReplyErrorStatus(QByteArray);
